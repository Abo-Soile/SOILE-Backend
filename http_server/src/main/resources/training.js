...
function getAndUpdateForm(f) {
  var tempP = formDAO.getP({ _id: f.old_id })
    .then(function (f) {
...
router.get("/training/:id/clone", function(request) {
  ...
  trainingDAO.get(id, function(train) {
    ...
    console.log(JSON.stringify(train.components.training));
