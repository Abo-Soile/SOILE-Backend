...
export VERTX_OPTS=" -server -Xms512m -Xmx1g -XX:MaxPermSize=64m -XX:NewRatio=2 -XX:SurvivorRatio=10 -Dorg.vertx.logger-delegate-factory-class-name=org.vertx.java.core.logging.impl.Log4jLogDelegateFactory"
